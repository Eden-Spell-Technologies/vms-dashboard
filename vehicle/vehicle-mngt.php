    ...
    <div id="main-wrapper" class="p-4 p-md-5">
        ...
        <div id="vehicle-mgmt-view" class="fade-in ">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4 col-lg-4">
                    <a class="vms-service-card text-decoration-none" href="./goods-inspection.php">
                        <div class="icon-wrapper bg-blue-light">
                            <i class="fas fa-clipboard-check fa-lg text-success"></i>
                        </div>
                        <h5>On Board Goods Inspection</h5>
                        <p>Verification of cargo, quality checks, and inventory logs</p>
                    </a>
                </div>
            </div>
        </div>
